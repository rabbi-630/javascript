...
// dark mod
document.getElementById("darkmod").addEventListener("click",function(){var e=document.body.classList.toggle("night");localStorage.setItem("darkmod-banner",e)}),jQuery(document).ready(function(e){e(function(){e("darkmod").click(function(e){e.preventDefault()})})});
// gird mod
document.getElementById("girdmod").addEventListener("click",function(){var e=document.body.classList.toggle("list");localStorage.setItem("girdmod-banner",e)}),jQuery(document).ready(function(e){e(function(){e("girdmod").click(function(e){e.preventDefault()})})});
// Ctrl u
...
/* Js áp dụng cho cả blog - www.nguyentinhblog.com */
