...
$('#backer .dark').click(function(){$('#backer .darkmod ul').slideToggle()
$('#backer .darkmod .expand_more').toggle()
$('#backer .darkmod .expand_less').toggle()})
$('#backer .gird').click(function(){$('#backer .girdmod ul').slideToggle()
...
return o}
$(".recent-comments ul").append('<li><div class="rc_avatar"><img src='+l+' alt="'+c+'" /></div><div class="rc_block"><div class="rc_header"><span class="rc_user"><a rel="nofollow" href='+a+' title="'+c+'">'+c+'</a></span><span class="rc_date"><a rel="nofollow" href='+a+'>'+s+'</a></span></div><p class="rc_content">'+formatUrl(o)+"</p></div></li>")}}function replaceText(){bodyText=document.getElementsByClassName('recent-comments')[0]
