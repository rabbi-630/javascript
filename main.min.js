$(document).ready(function() {
  $(".apps").each(function() {
      ...
      $(".drop", d).click(function(n) {
          return n.preventDefault(), $div = $(".gb_fa", d), $div.slideToggle(), $(".gb_fa").not($div).hide(), !1
      })
      ...
      $(".dropss", d).click(function(n) {
          return n.preventDefault(), $div = $(".au-menu", d), $div.slideToggle(), $(".au-menu").not($div).hide(), !1
      })
      ...
      $(".dropsss", d).click(function(n) {
          return n.preventDefault(), $div = $(".tb-menu", d), $div.slideToggle(), $(".tb-menu").not($div).hide(), !1
      })
      ...
      $(".tt_tg", d).click(function(n) {
          return n.preventDefault(), $div = $(".tg-menu", d), $div.slideToggle(), $(".tg-menu").not($div).hide(), !1
      })
      ...
      $(".dropdown-link", d).click(function(n) {
          return n.preventDefault(), $div = $(".dropdown-container", d), $div.slideToggle(), $(".dropdown-container").not($div).hide(), !1
      })
      ...
      $(".drops", d).click(function(n) {
          return n.preventDefault(), $div = $(".dd-menu", d), $div.slideToggle(), $(".dd-menu").not($div).hide(), !1
      })
      ...
      $(".dropdwn", d).click(function(n) {
          return n.preventDefault(), $div = $(".dds-menu", d), $div.slideToggle(), $(".dds-menu").not($div).hide(), !1
      })
  ...
  $('html,.drop,.drops,.dropss,.dropsss,.tt_tg,.dropdown-link,.dropdwn,.bg_Se input').click(function() {
  ...
  $('#backer .dark').click(function() {
      $('#backer .darkmod ul').slideToggle()
      $('#backer .darkmod .expand_more').toggle()
      $('#backer .darkmod .expand_less').toggle()
  })
  $('#backer .gird').click(function() {
      $('#backer .girdmod ul').slideToggle()
      $('#backer .girdmod .expand_more').toggle()
      $('#backer .girdmod .expand_less').toggle()
  })
  $('#backer .blog').click(function() {
      $('#backer .blog ul').slideToggle()
      $('#backer .blog .expand_more').toggle()
      $('#backer .blog .expand_less').toggle()
  })
  $('#backer .facebook').click(function() {
      $('#backer .facebook ul').slideToggle()
      $('#backer .facebook .expand_more').toggle()
      $('#backer .facebook .expand_less').toggle()
  })
  $('#backer .maytinh').click(function() {
      $('#backer .maytinh ul').slideToggle()
      $('#backer .maytinh .expand_more').toggle()
      $('#backer .maytinh .expand_less').toggle()
  })
  $('#backer .psdcmnd').click(function() {
      $('#backer .psdcmnd ul').slideToggle()
      $('#backer .psdcmnd .expand_more').toggle()
      $('#backer .psdcmnd .expand_less').toggle()
  })
  $('#backer .download').click(function() {
      $('#backer .download ul').slideToggle()
  ...
  jQuery(document).ready(function($) {
      $(window).scroll(function() {
          ...
          if (scroll > lastScroll) {
              $('#backer').removeClass('default').addClass('fixed')
              $('#backer .list-label-widget-content').addClass('invisible')
              $('#backer button.open').removeClass('hidden')
              $('.gb_Se').removeClass('gb_af')
              $('#backer button.close,.overlay,.dong-menu').addClass('hidden')
          } else if (scroll < lastScroll) {
              $('#backer').addClass('default').removeClass('fixed')
          }
          lastScroll = scroll;
      })
  })
  ...
  if (e.feed.entry) {
      for (var t = 0; t < e.feed.entry.length; t++) {
          ...
          var n = e.feed.entry[t].published.$t,
              l = e.feed.entry[t].author[0].gd$image.src.replace("//img1.blogblog.com/img/b16-rounded.gif", "//lh3.googleusercontent.com/zFdxGE77vvD2w5xHy6jkVuElKv-U9_9qLkRYK8OnbDeJPtjSZ82UPq5w6hJ-SA=s40"),
              s = n.substring(8, 10) + "/" + n.substring(5, 7) + "/" + n.substring(0, 4),
